...
public class RemoveRIPv2NetworkAPIMethod extends DefaultAPIMethod {

    public RemoveRIPv2NetworkAPIMethod(RouterController routerController) {
        super(routerController, "remove-ripv2-network");
    }
    ...
    public JsonObjectBuilder executePost(RouterController routerController, HttpServletRequest request, HttpServletResponse response) throws APIMethodException {
        try {
            ...
            routingModule.getNetworkPrefixList().remove(prefix);
