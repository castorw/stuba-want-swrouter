...
public class Packet {
    ...
    private IPv4Address forwarderIPv4Address;
    private MACAddress forwarderHardwareAddress;
    ...
    public void setForwarderHardwareAddress(MACAddress hardwareAddress, boolean overwriteDestination) {
        this.forwarderHardwareAddress = hardwareAddress;
        if (overwriteDestination) {
            this.setDestinationHardwareAddress(hardwareAddress);
        }
    }
